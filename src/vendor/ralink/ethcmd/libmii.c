...
#include "../../../kernel/linux-2.6.36/arch/mips/include/asm/tc3162/tc3162.h"
#else
#include "../../../linux/include/asm-mips/tc3162/tc3162.h"
#endif
#include "../mt7530/tcphy/tcswitch.h"
#include <fcntl.h>
...
searchSwic(int skfd, struct ifreq ifr){
	...
	if (swcfg.swic_id == MT7530){
		...
		if (_isMT751020){
			efuse_extreme_mode = mdio_reg_read(skfd, ifr, 0xBFBF8214);
...
mt7530_init_api(swic_api_t* swic){
	...
	swic->spTag=NULL;
#ifdef JUDGE_SWITCH_SCENARIO_BY_751020_SUBMODEL
	if(_isMT7520 || _isMT7520G || _isMT7525 || _isMT7525G)
