/*
** $Id: //BBN_Linux/Branch/Branch_for_Kernel_Upgrade_20120517/tclinux_phoenix/modules/private/tc3162l2hp2h/mac_tc3162l2.c#1 $
*/
/************************************************************************
 *
...
)
{
	...
	#endif	
	{
	miiStationWrite( mac_p, PHY_CONTROL_REG, BMCR_RESET);
...
static void tc3162_mac_link_status(unsigned long data)
{
	...
	if( swicVendor ) {
		...
		if ( status & (BMCR_RESET | PHY_POWER_DOWN) ) 
		{
			goto leave;
		}
		#ifdef TCPHY_SUPPORT
