...
#define RAW_CELL_FG			(1<<2)
#define MPOA_ON_FG			(1<<3)
#define OAM_CELL_FG			(1<<4)
#define CC_CELL_FG			(1<<5)
#define VLAN_TAG_FG			(1<<6)
#define HW_MPOA_FG			(1<<7)
#define HW_VLAN_UNTAG_FG	(1<<8)
#define HW_WRR_RULE_FG		(1<<9)
#define CC_CONT_FG			(1<<10)


#define AX4K_LBPK_DN		0
#define AX4K_LBPK_EN		(1<<0)

#define IP_TOS_INDEX	23
