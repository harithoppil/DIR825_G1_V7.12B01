...
*/
	...
	var devObjPath = ":InternetGatewayDevice.X_TWSZ-Device_list.Customer_Device." + objDevice.DEVICES.idDevice + ".";
	var dataJson = "";
...
*/
	...
	$.ajax({
                ...
                {
                        "var:page":"*",
                        "del-obj":"InternetGatewayDevice.X_TWSZ-Device_list.Customer_Device."+idDevice+".",
                        "obj-action":"del",
                        "var:noredirect":"1"
                },
                success:function(returnData, status){
...
function set3G(threeG_JSON, callback){	
	...
	var threeGPath = "InternetGatewayDevice.X_TWSZ-COM_USB3G.";
	var errorDescription="";
	var dataJson = "";
	dataJson = tbsItemBegin("var:page", "*");
	dataJson += tbsFormatAItem("obj-action", "set");
	...
	dataJson += tbsFormatAItem(":" + threeGPath + "USB3GEnable", threeGInfo.Enable);
       dataJson += tbsFormatAItem(":" + threeGPath + "EnterPinCode", threeGInfo.pinCode);
...
function addApplicationRule(idApplication, applicationRuleJSON)
{
	var objRule = applicationRuleJSON;
        ...
        $.ajax({
                ...
                cache: false,
                data:{
                        "add-obj" : "InternetGatewayDevice.X_TWSZ-Device_list.Applications."+idApplication+".Rules.",
                        "obj-action" : "add-set",
...
*/
	...
	$.ajax({
		...
		data:{
			"var:page" :"*",
			"add-obj" : "InternetGatewayDevice.X_TWSZ-Device_list.Applications.",
			"obj-action" : "add-set",
			":Enable" : "1",
...
*/
	...
	$.ajax({
                ...
                {
                        "var:page":"*",
                        "del-obj":"InternetGatewayDevice.X_TWSZ-Device_list.Applications."+idApplication+".",
                        "obj-action":"del",
                        "var:noredirect":"1"
                },
                success:function(returnData, status){
...
*/
	...
	$.ajax({
                ...
                {
                        "var:page":"*",
                        "del-obj":"InternetGatewayDevice.X_TWSZ-Device_list.Applications."+idApplication+".Rules." +idRule+".",
                        "obj-action":"del",
			            "var:idApplication":idApplication,
                        "var:noredirect":"1"
                },
...
*/
	...
	var objApp = eval('('+ applicationJSON + ')');
	var appPath = ":InternetGatewayDevice.X_TWSZ-Device_list.Applications."  + objApp.APPLICATION.idApplication + ".";
	...
	if (objApp.APPLICATION.RULES.length > 0){
		...
		for (var i=0; i<len; i++){
			...
			var rulePath = ":InternetGatewayDevice.X_TWSZ-Device_list.Applications." + objApp.APPLICATION.idApplication + ".Rules." + rulesObj[i].idRule + ".";
...
*/
	...
	{
		AppObjPath = ":InternetGatewayDevice.X_TWSZ-Device_list.Applications." + objAPPlist.APPLICATION_LIST[i].idApplication + ".";
