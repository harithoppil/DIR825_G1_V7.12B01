...
#define MID_DUAL_ACCESS	((PID_CCP << 8) | 0x68)     /* linsd add Dual access模块 */
...
#define MID_INBOUND      ((PID_CCP << 8) | 0x9e)     /* wan过滤模块 */
#define MID_MAIL      ((PID_CCP << 8) | 0x9f)     /* mail MID */
...
#define MID_MDNS      ((PID_CCP << 8) | 0xa3)/*mdns*/
...
#define MID_GRP_WAN_PROTOCOL_CHANGED  (((PID_CCP << 8) | MID_GRP_BASE) + 44)

#define MID_SYSLOG_SELF ((PID_SYSLOG_SELF << 8)   | 0x01)
...
//    MSG_WAN_DEL_CONN,       /* 0029 */   /*WAN连接实例删除消息*/
    ...
    MSG_WAN_CONN_FIN,
    MSG_WAN_LINK_CHG,
    MSG_WAN_PROT_CHG,	/* WAN连接实例协议类型改变消息 */
    ...
    MSG_WLAN_WLANPASSWD,
    MSG_CONN_DNS_UPDATE,
	MSG_DUAL_ACCESS_CONNECTED,				/*dual access connectd*/
    MSG_MAIL_SEND,                          /* 通知发送邮件消息 */
    MSG_LOG_SEND,
    MSG_CMM_CLEAR_LANG,
    MSG_LOG_FULL,
    MSG_RA0_WPS_CONFIG_FIN,
    MSG_RAI0_WPS_CONFIG_FIN,
    MSG_RA0_WPSENROLL_CONFIG_FIN,
    MSG_RAI0_WPSENROLL_CONFIG_FIN,
	...
	MSG_WLAN_SSID_CHANGED,
	MSG_SPI_ENABLE_CHANGED,
    MSG_PUB_END      = 0x7FFF
...
#define MSG_WAN_PROT_CHG_ACK                      TBS_MSG_ACK_TYPE(MSG_WAN_PROT_CHG)
...
#define MSG_CONN_DNS_UPDATE_ACK 				  TBS_MSG_ACK_TYPE(MSG_CONN_DNS_UPDATE)
