...
typedef enum tag_EN_IPT_ChainId
{
    ...
    CN_ANTI_SYN_PRE,
	CN_SPI_PRE, //linsd add     
    CN_REMOTE_MANAGE_PRE,
    CN_ACL_ALLOW_PRE,
    CN_ACL_REMOTE_SUB,
    CN_ACL_REMOTE_PRE,
    PTMP_PREROUTING,
    ...
    TCPMSS_FORWARD,
    MAC_WhiteFILTER_FORWARD,
    MAC_BlackFILTER_FORWARD,
    ...
    MAC_WhiteFILTER_INPUT,
    MAC_BlackFILTER_INPUT,  //linsd add for mac filter on input chain
