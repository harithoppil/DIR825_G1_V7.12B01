...
#if 0
    //GPIO B3
	REG32(PIN_MUX_SEL_2) &= ~0x18;
	REG32(PIN_MUX_SEL_2) |= 0x18;
	REG32(PABCD_DIR) = REG32(PABCD_DIR) |(0x1<<11);
	REG32(PABCD_DAT) = REG32(PABCD_DAT) |(0x1<<11);
#endif

	//GPIO B4 
	REG32(PIN_MUX_SEL_2) &= ~0xc0;
	REG32(PIN_MUX_SEL_2) |= 0xc0;
	REG32(PABCD_DIR) = REG32(PABCD_DIR) |(0x1<<12);
	REG32(PABCD_DAT) = REG32(PABCD_DAT) |(0x1<<12);
}
