...
//dual band
#if (defined (CONFIG_USE_PCIE_SLOT_0)&&defined (CONFIG_USE_PCIE_SLOT_1))||( defined(CONFIG_RTL_8881A)&& !defined(CONFIG_RTL_8881A_SELECTIVE))|| defined(CONFIG_WLAN_HAL_8814AE)
...
//-------------------------------------------------------------
#if !defined(CONFIG_RTL8196B_GW_8M) && !defined(__OSK__) //&&!defined(CONFIG_RTL_92D_SUPPORT)
...
#define BROADCAST_STORM_THRESHOLD		500 //16
...
#endif
#else
#if defined(CONFIG_RTL_8198) || defined(CONFIG_RTL_819XD)  || defined(CONFIG_RTL_8198C) || defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8198B)  || (defined(CONFIG_LUNA_DUAL_LINUX) || defined(CONFIG_ARCH_LUNA_SLAVE)) || defined(CONFIG_RTL8672) || defined(CONFIG_RTL_8723B_SUPPORT)
...
//-------------------------------------------------------------
				...
				#define MAX_SKB_NUM		100
					...
					#endif
				#else
					#if (defined(CONFIG_SLOT_0_8194AE) || defined(CONFIG_SLOT_1_8194AE)) && defined(CONFIG_RTL8672)
					#define MAX_SKB_NUM		768
					#elif CONFIG_WLAN_HAL_8814AE
						#define MAX_SKB_NUM		2048
					#else	
					#define MAX_SKB_NUM		768
				#endif
				#endif
