...
/*	//
	...
	s1Byte			Modify_TxAGC_Value_OFDM;         //Remnat compensate value at TxAGC :OFDM:  Add by Mingzhi.Guo
	s1Byte			Modify_TxAGC_Value_CCK;            //Remnat compensate value at TxAGC :CCK     Add by Mingzhi.Guo
