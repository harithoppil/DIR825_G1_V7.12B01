...
EXTERN void rtw_bb_rf_gain_offset(struct rtl8192cd_priv *priv);
#endif
#endif
...
EXTERN void turnoff_hw_LED(struct rtl8192cd_priv *priv, unsigned int led_type);
...
EXTERN unsigned char stactrl_check_request(struct rtl8192cd_priv *priv, unsigned char *mac, int frame_type);
#ifdef CONFIG_RTL_PROC_NEW
