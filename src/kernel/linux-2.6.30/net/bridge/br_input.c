...
#define RTL_WLAN0_VAP_INT_PREFIX "wlan0-va"
#define RTL_WLAN1_VAP_INT_PREFIX "wlan1-va"
...
ap_hcm_out:	
	...
	if (skb) {
		...
		#endif
		if((!memcmp(skb->dev->name,RTL_WLAN0_VAP_INT_PREFIX,sizeof(RTL_WLAN0_VAP_INT_PREFIX)-1))
			||(!memcmp(skb->dev->name,RTL_WLAN1_VAP_INT_PREFIX,sizeof(RTL_WLAN1_VAP_INT_PREFIX)-1)))
		 goto drop;
