...
/* TBS_TAG: by pengyao 2012-05-23 Desc:for dproxy*/
static int sock_get6_recvif(struct sock *sk, char __user *recvif)
{
    return copy_to_user(recvif, sk->recvdev, sizeof(sk->recvdev)) ? -EFAULT: 0;
}
#endif
/* TBS_TAG: by WuGuoxiang 2012-7-11 Desc: Added for TBS ipv6 */
...
int inet6_ioctl(struct socket *sock, unsigned int cmd, unsigned long arg)
{
    ...
    case SIOCGRECVIF:
        return sock_get6_recvif(sk, (char __user *)arg);
        break;
#endif
	default:
		if (!sk->sk_prot->ioctl)
