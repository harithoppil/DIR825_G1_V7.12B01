...
#define CONFIG_LED_RTL8197D_PROTEST 1
#define RTK_QUE			1
...
#if defined(CONFIG_LED_RTL8197D_PROTEST)
#define RTL819X_IOCTL_ETH_PORT_LEDON	         (SIOCDEVPRIVATE + 0x05)
#define RTL819X_IOCTL_ETH_PORT_LEDOFF	         (SIOCDEVPRIVATE + 0x06)
#define RTL819X_IOCTL_ETH_PORT_LEDRESTORE	     (SIOCDEVPRIVATE + 0x07)
#endif
