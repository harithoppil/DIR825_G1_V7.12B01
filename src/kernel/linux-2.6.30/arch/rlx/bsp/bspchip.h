...
/* redefine to compat old code */
#define GPIO_ABCD_IRQ       BSP_GPIO_ABCD_IRQ
#define GPIO_EFGH_IRQ       BSP_GPIO_EFGH_IRQ

//#define GIMR                BSP_GIMR
...
extern void gpioConfigIntr1(int enable);
