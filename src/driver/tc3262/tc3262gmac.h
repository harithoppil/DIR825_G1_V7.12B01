/*
** $Id: //BBN_Linux/Branch/Branch_for_Kernel_Upgrade_20120517/tclinux_phoenix/modules/private/tc3262/tc3262gmac.h#2 $
*/
/************************************************************************
 *
...
#define MIB_TX_UCAST_REG 		(MIB_BASE_REG + 0x0004)
#define MIB_TX_MCAST_REG 		(MIB_BASE_REG + 0x0008)
#define MIB_TX_BCAST_REG 		(MIB_BASE_REG + 0x000c)
#define MIB_TX_COL_REG 			(MIB_BASE_REG + 0x0010)
#define MIB_TX_SCOL_REG 		(MIB_BASE_REG + 0x0014)
#define MIB_TX_MCOL_REG 		(MIB_BASE_REG + 0x0018)
#define MIB_TX_DEFER_REG 		(MIB_BASE_REG + 0x001c)
#define MIB_TX_LCOL_REG 		(MIB_BASE_REG + 0x0020)
#define MIB_TX_XCOL_REG 		(MIB_BASE_REG + 0x0024)
#define MIB_TX_PAUSE_REG 		(MIB_BASE_REG + 0x0028)

#define MIB_RX_DROP_REG 		(MIB_BASE_REG + 0x0030)
#define MIB_RX_FILTER_REG 		(MIB_BASE_REG + 0x0034)
#define MIB_RX_UCAST_REG 		(MIB_BASE_REG + 0x0038)
#define MIB_RX_MCAST_REG 		(MIB_BASE_REG + 0x003c)
#define MIB_RX_BCAST_REG 		(MIB_BASE_REG + 0x0040)
#define MIB_RX_ALIGN_ERR_REG 	(MIB_BASE_REG + 0x0044)
#define MIB_RX_FCS_ERR_REG 		(MIB_BASE_REG + 0x0048)
#define MIB_RX_UNDERSIZE_REG 	(MIB_BASE_REG + 0x004c)
#define MIB_RX_FRAG_ERR_REG 	(MIB_BASE_REG + 0x0050)
#define MIB_RX_OVERSIZE_REG 	(MIB_BASE_REG + 0x0054)
#define MIB_RX_JABB_ERR_REG 	(MIB_BASE_REG + 0x0058)
#define MIB_RX_PAUSE_REG 		(MIB_BASE_REG + 0x005c)

#define MIB_BX_PKT_64_CNT 		(MIB_BASE_REG + 0x0060)
#define MIB_BX_PKT_65TO127_CNT 	(MIB_BASE_REG + 0x0064)
#define MIB_BX_PKT_128TO255_CNT (MIB_BASE_REG + 0x0068)
#define MIB_BX_PKT_256TO511_CNT (MIB_BASE_REG + 0x006c)
#define MIB_BX_PKT_512TO1023_CNT (MIB_BASE_REG + 0x0070)
#define MIB_BX_PKT_1024TOMAX_CNT (MIB_BASE_REG + 0x0074)

#define MIB_TX_OCT_CNT_L 		(MIB_BASE_REG + 0x0080)
#define MIB_TX_OCT_CNT_H 		(MIB_BASE_REG + 0x0084)
#define MIB_RX_OCT_CNT_L 		(MIB_BASE_REG + 0x0088)
#define MIB_RX_OCT_CNT_H 		(MIB_BASE_REG + 0x008c)
