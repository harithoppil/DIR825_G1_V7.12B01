/*
** $Id: //BBN_Linux/Branch/Branch_for_Kernel_Upgrade_20120517/tclinux_phoenix/modules/private/tcphy/tcetherphy.h#1 $
*/
...
#if defined(TC2206_SUPPORT) || defined(CONFIG_RT65168) || defined(CONFIG_TCSUPPORT_CPU_RT65168)
...
#endif
#if defined(TC6501_SUPPORT) || defined(RT63365_SUPPORT) || defined(TC6508_SUPPORT)
...
#else 
#if (defined(TC2104MC_SUPPORT) || defined(TC2104SD_SUPPORT) || defined(TC2104ME_SUPPORT))
...
*
*************************************************************************/
#if (defined(TC2104MC_SUPPORT) || defined(TC2104SD_SUPPORT)|| defined(TC2104ME_SUPPORT) || defined(TC2105MJ_SUPPORT))
