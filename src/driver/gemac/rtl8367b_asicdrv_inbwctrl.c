 ...
 *      None
 */
int rtl8367b_setAsicPortIngressBandwidth(unsigned int port, unsigned int bandwidth, unsigned int preifg, unsigned int enableFC)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicPortIngressBandwidth(unsigned int port, unsigned int* pBandwidth, unsigned int* pPreifg, unsigned int* pEnableFC)
{
	int retVal;
	unsigned int regData;
	unsigned int regAddr;
 ...
 *      None
 */
int rtl8367b_setAsicPortIngressBandwidthBypass(unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicPortIngressBandwidthBypass(unsigned int* pEnabled)
{
