 ...
 */
int rtl8367b_setAsicFieldSelector(unsigned int index, unsigned int format, unsigned int offset)
{
 ...
 *      None
 */
int rtl8367b_getAsicFieldSelector(unsigned int index, unsigned int* pFormat, unsigned int* pOffset)
{
    int retVal;
	unsigned int regData;
