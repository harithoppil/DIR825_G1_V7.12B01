 ...
 *      None
 */
int rtl8367b_setAsicRma(unsigned int index, rtl8367b_rma_t* pRmacfg)
{
    ...
    regData = *(unsigned short*)pRmacfg;
 ...
 *      None
 */
int rtl8367b_getAsicRma(unsigned int index, rtl8367b_rma_t* pRmacfg)
{
    int retVal;
    unsigned int regData;
