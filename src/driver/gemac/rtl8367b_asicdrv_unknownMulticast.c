 ...
 *      None
 */
int rtl8367b_setAsicUnknownL2MulticastBehavior(unsigned int port, unsigned int behave)
{
 ...
 *      None
 */
int rtl8367b_getAsicUnknownL2MulticastBehavior(unsigned int port, unsigned int *pBehave)
{
	if(port >  RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicUnknownIPv4MulticastBehavior(unsigned int port, unsigned int behave)
{
	if(port >  RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicUnknownIPv4MulticastBehavior(unsigned int port, unsigned int *pBehave)
{
	if(port >  RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicUnknownIPv6MulticastBehavior(unsigned int port, unsigned int behave)
{
	if(port >  RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicUnknownIPv6MulticastBehavior(unsigned int port, unsigned int *pBehave)
{
	if(port >  RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicUnknownMulticastTrapPriority(unsigned int priority)
{
 ...
 *      None
 */
int rtl8367b_getAsicUnknownMulticastTrapPriority(unsigned int *pPriority)
{
