 ...
 */
extern int rtk_switch_init(void);
 ...
 *      - MAXPKTLEN_16000B.
 */
extern int rtk_switch_maxPktLen_set(rtk_switch_maxPktLen_t len);
 ...
 */
extern int rtk_switch_maxPktLen_get(rtk_switch_maxPktLen_t *pLen);
 ...
 *      configuration.
 */
extern int rtk_switch_portMaxPktLen_set(unsigned int port, unsigned int length);
 ...
 */
extern int rtk_switch_portMaxPktLen_get(unsigned int port, unsigned int *pLength);
 ...
 *      - ENABLE
 */
extern int rtk_switch_greenEthernet_set(rtk_enable_t enable);
 ...
 */
extern int rtk_switch_greenEthernet_get(rtk_enable_t *pEnable);
 ...
 */
extern int rtk_rate_shareMeter_set(rtk_meter_id_t index, rtk_rate_t rate, rtk_enable_t ifg_include);
 ...
 */
extern int rtk_rate_shareMeter_get(rtk_meter_id_t index, rtk_rate_t *pRate ,rtk_enable_t *pIfg_include);
 ...
 */
extern int rtk_rate_shareMeterBucket_set(rtk_meter_id_t index, unsigned int bucket_size);
 ...
 */
extern int rtk_rate_shareMeterBucket_get(rtk_meter_id_t index, unsigned int *pBucket_size);
 ...
 *      The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern int rtk_rate_igrBandwidthCtrlRate_set( unsigned int port, rtk_rate_t rate,  rtk_enable_t ifg_include, rtk_enable_t fc_enable);
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern int rtk_rate_igrBandwidthCtrlRate_get(unsigned int port, rtk_rate_t *pRate, rtk_enable_t *pIfg_include, rtk_enable_t *pFc_enable);
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern int rtk_rate_egrBandwidthCtrlRate_set(unsigned int port, rtk_rate_t rate,  rtk_enable_t ifg_includ);
 ...
 *     The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern int rtk_rate_egrBandwidthCtrlRate_get(unsigned int port, rtk_rate_t *pRate, rtk_enable_t *pIfg_include);
 ...
 *      None
 */
extern int rtk_rate_egrQueueBwCtrlEnable_set(unsigned int port, rtk_qid_t queue, rtk_enable_t enable);
 ...
 *    None.
 */
extern int rtk_rate_egrQueueBwCtrlEnable_get(unsigned int port, rtk_qid_t queue, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_rate_egrQueueBwCtrlRate_set(unsigned int port, rtk_qid_t queue, rtk_meter_id_t index);
 ...
 *    The unit of granularity is 8Kbps.
 */
extern int rtk_rate_egrQueueBwCtrlRate_get(unsigned int port, rtk_qid_t queue, rtk_meter_id_t *pIndex);


/*Storm Control Rate*/
#if defined(EMBEDDED_SUPPORT)
extern int rtk_storm_controlRate_set(unsigned int port, rtk_rate_storm_group_t storm_type, rtk_rate_t rate, rtk_enable_t ifg_include, unsigned int mode) reentrant;
extern int rtk_storm_controlRate_get(unsigned int port, rtk_rate_storm_group_t storm_type, rtk_rate_t *pRate, rtk_enable_t *pIfg_include, unsigned int mode) reentrant;
#else
/* Function Name:
 ...
 *      The ifg_include parameter is used for rate calculation with/without inter-frame-gap and preamble.
 */
extern int rtk_storm_controlRate_set(unsigned int port, rtk_rate_storm_group_t storm_type, rtk_rate_t rate, rtk_enable_t ifg_include, unsigned int mode);
 ...
 *          - STORM_GROUP_BROADCAST
 */
extern int rtk_storm_controlRate_get(unsigned int port, rtk_rate_storm_group_t storm_type, rtk_rate_t *pRate, rtk_enable_t *pIfg_include, unsigned int mode);
#endif
 ...
 *      - BYPASS_IGMP.
 */
extern int rtk_storm_bypass_set(rtk_storm_bypass_t type, rtk_enable_t enable);
 ...
 *      - BYPASS_IGMP.
 */
extern int rtk_storm_bypass_get(rtk_storm_bypass_t type, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_qos_init(rtk_queue_num_t queueNum);
 ...
 *      - PRIDEC_SA
 */
extern int rtk_qos_priSel_set(rtk_priority_select_t *pPriDec);
 ...
 *      - PRIDEC_SA,
 */
extern int rtk_qos_priSel_get(rtk_priority_select_t *pPriDec);
 ...
 */
extern int rtk_qos_1pPriRemap_set(rtk_pri_t dot1p_pri, rtk_pri_t int_pri);
 ...
 */
extern int rtk_qos_1pPriRemap_get(rtk_pri_t dot1p_pri, rtk_pri_t *pInt_pri);
 ...
 */
extern int rtk_qos_dscpPriRemap_set(unsigned int dscp, rtk_pri_t int_pri);
 ...
 *      DSCP are carefully chosen then backward compatibility can be achieved.
 */
extern int rtk_qos_dscpPriRemap_get(unsigned int dscp, rtk_pri_t *pInt_pri);
 ...
 */
extern int rtk_qos_portPri_set(unsigned int port, rtk_pri_t int_pri) ;
 ...
 */
extern int rtk_qos_portPri_get(unsigned int port, rtk_pri_t *pInt_pri) ;
 ...
 */
extern int rtk_qos_queueNum_set(unsigned int port, rtk_queue_num_t queue_num);
 ...
 */
extern int rtk_qos_queueNum_get(unsigned int port, rtk_queue_num_t *pQueue_num);
 ...
 */
extern int rtk_qos_priMap_set(rtk_queue_num_t queue_num, rtk_qos_pri2queue_t *pPri2qid);
 ...
 *      The queue number is from 1 to 8.
 */
extern int rtk_qos_priMap_get(rtk_queue_num_t queue_num, rtk_qos_pri2queue_t *pPri2qid);
 ...
 */
extern int rtk_qos_schedulingQueue_set(unsigned int port, rtk_qos_queue_weights_t *pQweights);
 ...
 */
extern int rtk_qos_schedulingQueue_get(unsigned int port, rtk_qos_queue_weights_t *pQweights);
 ...
 *      - ENABLED
 */
extern int rtk_qos_1pRemarkEnable_set(unsigned int port, rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern int rtk_qos_1pRemarkEnable_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_qos_1pRemark_set(rtk_pri_t int_pri, rtk_pri_t dot1p_pri);
 ...
 */
extern int rtk_qos_1pRemark_get(rtk_pri_t int_pri, rtk_pri_t *pDot1p_pri);
 ...
 *      - ENABLED
 */
extern int rtk_qos_dscpRemarkEnable_set(unsigned int port, rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern int rtk_qos_dscpRemarkEnable_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_qos_dscpRemark_set(rtk_pri_t int_pri, unsigned int dscp);
 ...
 */
extern int rtk_qos_dscpRemark_get(rtk_pri_t int_pri, unsigned int *pDscp);
 ...
 */
extern int rtk_trap_unknownUnicastPktAction_set(rtk_trap_ucast_type_t type, rtk_trap_ucast_action_t ucast_action);
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
extern int rtk_trap_unknownUnicastPktAction_get(rtk_trap_ucast_type_t type, rtk_trap_ucast_action_t *pUcast_action);
 ...
 */
extern int rtk_trap_unknownMcastPktAction_set(unsigned int port, rtk_mcast_type_t type, rtk_trap_mcast_action_t mcast_action);
 ...
 *          - MCAST_ACTION_TRAP2CPU
 */
extern int rtk_trap_unknownMcastPktAction_get(unsigned int port, rtk_mcast_type_t type, rtk_trap_mcast_action_t *pMcast_action);
 ...
 */
extern int rtk_trap_igmpCtrlPktAction_set(rtk_igmp_type_t type, rtk_trap_igmp_action_t igmp_action);
 ...
 *          - IGMP_ACTION_FORWARD_EXCLUDE_CPU
 */
extern int rtk_trap_igmpCtrlPktAction_get(rtk_igmp_type_t type, rtk_trap_igmp_action_t *pIgmp_action);
 ...
 */
extern int rtk_trap_rmaAction_set(rtk_mac_t *pRma_frame, rtk_trap_rma_action_t rma_action);
 ...
 *      - RMA_ACTION_FORWARD_EXCLUDE_CPU
 */
extern int rtk_trap_rmaAction_get(rtk_mac_t *pRma_frame, rtk_trap_rma_action_t *pRma_action);
 ...
 *      - ENABLED
 */
extern int rtk_trap_ethernetAv_set(rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern int rtk_trap_ethernetAv_get(rtk_enable_t *pEnable);
 ...
 *      - LEAKY_IPMULTICAST.
 */
extern int rtk_leaky_vlan_set(rtk_leaky_type_t type, rtk_enable_t enable);
 ...
 *      - LEAKY_IPMULTICAST.
 */
extern int rtk_leaky_vlan_get(rtk_leaky_type_t type, rtk_enable_t *pEnable);
 ...
 *      - LEAKY_IPMULTICAST.
 */
extern int rtk_leaky_portIsolation_set(rtk_leaky_type_t type, rtk_enable_t enable);
 ...
 *      - LEAKY_IPMULTICAST.
 */
extern int rtk_leaky_portIsolation_get(rtk_leaky_type_t type, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_port_phyAutoNegoAbility_set(unsigned int port, rtk_port_phy_ability_t *pAbility);
 ...
 */
extern int rtk_port_phyAutoNegoAbility_get(unsigned int port, rtk_port_phy_ability_t *pAbility);
 ...
 *      be set as following 100F > 100H > 10F > 10H priority sequence.
 */
extern int rtk_port_phyForceModeAbility_set(unsigned int port, rtk_port_phy_ability_t *pAbility);
 ...
 *      Get the capablity of specified PHY.
 */
extern int rtk_port_phyForceModeAbility_get(unsigned int port, rtk_port_phy_ability_t *pAbility);
 ...
 */
extern int rtk_port_phyStatus_get(unsigned int port, unsigned int *pLinkStatus, rtk_port_speed_t *pSpeed, rtk_port_duplex_t *pDuplex);
 ...
 */
extern int rtk_port_phyTestMode_set(unsigned int port, rtk_port_phy_test_mode_t mode);
 ...
 */
extern int rtk_port_phyTestMode_get(unsigned int port, rtk_port_phy_test_mode_t *pMode);
 ...
 */
extern int rtk_port_phy1000BaseTMasterSlave_set(unsigned int port, rtk_enable_t enabled, rtk_enable_t masterslave);
 ...
 */
extern int rtk_port_macForceLink_set(unsigned int port, rtk_port_mac_ability_t *pPortability);
 ...
 */
extern int rtk_port_macForceLink_get(unsigned int port, rtk_port_mac_ability_t *pPortability);
 ...
 *      - MODE_EXT_RMII_PHY,
 */
extern int rtk_port_macForceLinkExt0_set(rtk_mode_ext_t mode, rtk_port_mac_ability_t *pPortability);
 ...
 */
extern int rtk_port_macForceLinkExt0_get(rtk_mode_ext_t *pMode, rtk_port_mac_ability_t *pPortability);
 ...
 *      - MODE_EXT_RMII_PHY,
 */
extern int rtk_port_macForceLinkExt1_set(rtk_mode_ext_t mode, rtk_port_mac_ability_t *pPortability);
 ...
 */
extern int rtk_port_macForceLinkExt1_get(rtk_mode_ext_t *pMode, rtk_port_mac_ability_t *pPortability);
 ...
 *      - MODE_EXT_RMII_PHY,
 */
extern int rtk_port_macForceLinkExt_set(rtk_ext_port_t port, rtk_mode_ext_t mode, rtk_port_mac_ability_t *pPortability);
 ...
 */
extern int rtk_port_macForceLinkExt_get(rtk_ext_port_t port, rtk_mode_ext_t *pMode, rtk_port_mac_ability_t *pPortability);
 ...
 */
extern int rtk_port_macStatus_get(unsigned int port, rtk_port_mac_ability_t *pPortstatus);
 ...
 */
extern int rtk_port_macLocalLoopbackEnable_set(unsigned int port, rtk_enable_t enable);
 ...
 *      None.
 */
extern int rtk_port_macLocalLoopbackEnable_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_port_phyReg_set(unsigned int port, rtk_port_phy_reg_t reg, rtk_port_phy_data_t value);
 ...
 */
extern int rtk_port_phyReg_get(unsigned int port, rtk_port_phy_reg_t reg, rtk_port_phy_data_t *pData);
 ...
 *      - ENABLE
 */
extern int rtk_port_backpressureEnable_set(unsigned int port, rtk_enable_t enable);
 ...
 *      - ENABLE
 */
extern int rtk_port_backpressureEnable_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 *      - ENABLE
 */
extern int rtk_port_adminEnable_set(unsigned int port, rtk_enable_t enable);
 ...
 *      - ENABLE
 */
extern int rtk_port_adminEnable_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_port_isolation_set(unsigned int port, rtk_portmask_t portmask);
 ...
 *      A port can only transmit packet to ports included in permitted portmask
 */
extern int rtk_port_isolation_get(unsigned int port, rtk_portmask_t *pPortmask);
 ...
 */
extern int rtk_port_rgmiiDelayExt0_set(unsigned int txDelay, unsigned int rxDelay);
 ...
 *      In RX dekay, there are 8 steps for delay tunning. 0 for n0-delay, and 7 for maximum delay.
 */
extern int rtk_port_rgmiiDelayExt0_get(unsigned int *pTxDelay, unsigned int *pRxDelay);
 ...
 *      In RX dekay, there are 8 steps for delay tunning. 0 for n0-delay, and 7 for maximum delay.
 */
extern int rtk_port_rgmiiDelayExt1_set(unsigned int txDelay, unsigned int rxDelay);
 ...
 *      In RX dekay, there are 8 steps for delay tunning. 0 for n0-delay, and 7 for maximum delay.
 */
extern int rtk_port_rgmiiDelayExt1_get(unsigned int *pTxDelay, unsigned int *pRxDelay);
 ...
 */
extern int rtk_port_rgmiiDelayExt_set(rtk_ext_port_t port, unsigned int txDelay, unsigned int rxDelay);
 ...
 *      In RX dekay, there are 8 steps for delay tunning. 0 for n0-delay, and 7 for maximum delay.
 */
extern int rtk_port_rgmiiDelayExt_get(rtk_ext_port_t port, unsigned int *pTxDelay, unsigned int *pRxDelay);
 ...
 *      - ENABLE
 */
extern int rtk_port_phyEnableAll_get(rtk_enable_t *pEnable);
 ...
 */
extern int rtk_port_efid_set(unsigned int port, unsigned int efid);
 ...
 */
extern int rtk_port_efid_get(unsigned int port, unsigned int *pEfid);
 ...
 */
extern int rtk_port_phyComboPortMedia_set(unsigned int port, rtk_port_media_t media);
 ...
 *      The API can Set Combo port media type.
 */
extern int rtk_port_phyComboPortMedia_get(unsigned int port, rtk_port_media_t *pMedia);
 ...
 */
extern int rtk_port_rtctEnable_set(rtk_portmask_t portmask);
 ...
 */
extern int rtk_port_rtctResult_get(unsigned int port, rtk_rtctResult_t *pRtctResult);
 ...
 */
extern int rtk_vlan_set(rtk_vlan_t vid, rtk_portmask_t mbrmsk, rtk_portmask_t untagmsk, unsigned int fid);
 ...
 */
extern int rtk_vlan_get(rtk_vlan_t vid, rtk_portmask_t *pMbrmsk, rtk_portmask_t *pUntagmsk, unsigned int *pFid);
 ...
 *     Set a VLAN Member Configuration entry by index.
 */
extern int rtk_vlan_mbrCfg_set(unsigned int idx, rtk_vlan_mbrcfg_t *pMbrcfg);
 ...
 *     Get a VLAN Member Configuration entry by index.
 */
extern int rtk_vlan_mbrCfg_get(unsigned int idx, rtk_vlan_mbrcfg_t *pMbrcfg);
 ...
 */
extern int rtk_vlan_portPvid_set(unsigned int port, rtk_vlan_t pvid, rtk_pri_t priority);
 ...
 */
extern int rtk_vlan_portPvid_get(unsigned int port, rtk_vlan_t *pPvid, rtk_pri_t *pPriority);
 ...
 */
extern int rtk_vlan_portIgrFilterEnable_set(unsigned int port, rtk_enable_t igr_filter);
 ...
 *     - ENABLED
 */
extern int rtk_vlan_portIgrFilterEnable_get(unsigned int port, rtk_enable_t *pIgr_filter);
 ...
 */
extern int rtk_vlan_portAcceptFrameType_set(unsigned int port, rtk_vlan_acceptFrameType_t accept_frame_type);
 ...
 *     - ACCEPT_FRAME_TYPE_UNTAG_ONLY
 */
extern int rtk_vlan_portAcceptFrameType_get(unsigned int port, rtk_vlan_acceptFrameType_t *pAccept_frame_type);
 ...
 */
extern int rtk_vlan_vlanBasedPriority_set(rtk_vlan_t vid, rtk_pri_t priority);
 ...
 *     This API is used to set priority per VLAN.
 */
extern int rtk_vlan_vlanBasedPriority_get(rtk_vlan_t vid, rtk_pri_t *pPriority);
 ...
 */
extern int rtk_vlan_tagMode_set(unsigned int port, rtk_vlan_tagMode_t tag_mode);
 ...
 *      - VLAN_TAG_MODE_REAL_KEEP_FORMAT,
 */
extern int rtk_vlan_tagMode_get(unsigned int port, rtk_vlan_tagMode_t *pTag_mode);
 ...
 *      None.
 */
extern int rtk_vlan_transparent_set(unsigned int egr_port, rtk_portmask_t igr_pmask, rtk_enable_t enable);
 ...
 *      None.
 */
extern int rtk_vlan_transparent_get(unsigned int egr_port, rtk_portmask_t *pIgr_pmask, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_vlan_stg_set(rtk_vlan_t vid, rtk_stg_t stg);
 ...
 */
extern int rtk_vlan_stg_get(rtk_vlan_t vid, rtk_stg_t *pStg);
 ...
 *      - FRAME_TYPE_LLCOTHER
 */
extern int rtk_vlan_protoAndPortBasedVlan_add(unsigned int port, rtk_vlan_protoAndPortInfo_t info);
 ...
 *      - FRAME_TYPE_LLCOTHER
 */
extern int rtk_vlan_protoAndPortBasedVlan_get(unsigned int port, rtk_vlan_proto_type_t proto_type, rtk_vlan_protoVlan_frameType_t frame_type, rtk_vlan_protoAndPortInfo_t *pInfo);
 ...
 *      - FRAME_TYPE_LLCOTHER
 */
extern int rtk_vlan_protoAndPortBasedVlan_del(unsigned int port, rtk_vlan_proto_type_t proto_type, rtk_vlan_protoVlan_frameType_t frame_type);
 ...
 */
extern int rtk_vlan_protoAndPortBasedVlan_delAll(unsigned int port);
 ...
 */
extern int rtk_vlan_portFid_set(unsigned int port, rtk_enable_t enable, unsigned int fid);
 ...
 *      packets will be assigned to the port-based fid regardless vlan tag.
 */
extern int rtk_vlan_portFid_get(unsigned int port, rtk_enable_t *pEnable, unsigned int *pFid);
 ...
 */
extern int rtk_stp_mstpState_set(rtk_stp_msti_id_t msti, unsigned int port, rtk_stp_state_t stp_state);
 ...
 *      - STP_STATE_FORWARDING
 */
extern int rtk_stp_mstpState_get(rtk_stp_msti_id_t msti, unsigned int port, rtk_stp_state_t *pStp_state);
 ...
 */
extern int rtk_l2_addr_add(rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data);
 ...
 */
extern int rtk_l2_addr_get(rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data);
 ...
 */
extern int rtk_l2_addr_next_get(rtk_l2_read_method_t read_method, unsigned int port, unsigned int *pAddress, rtk_l2_ucastAddr_t *pL2_data);
 ...
 */
extern int rtk_l2_addr_del(rtk_mac_t *pMac, rtk_l2_ucastAddr_t *pL2_data);
 ...
 */
extern int rtk_l2_mcastAddr_add(rtk_mac_t *pMac, unsigned int ivl, unsigned int cvid_fid, rtk_portmask_t portmask);
 ...
 *      the mac is learned. Otherwise, it will return a RT_ERR_L2_ENTRY_NOTFOUND error.
 */
extern int rtk_l2_mcastAddr_get(rtk_mac_t *pMac, unsigned int ivl, unsigned int cvid_fid, rtk_portmask_t *pPortmask);
 ...
 */
extern int rtk_l2_mcastAddr_next_get(unsigned int *pAddress, rtk_mac_t *pMac, unsigned int *pIvl, unsigned int *pCvid_fid, rtk_portmask_t *pPortmask);
 ...
 *      If the mac has existed in the LUT, it will be deleted. Otherwise, it will return RT_ERR_L2_ENTRY_NOTFOUND.
 */
extern int rtk_l2_mcastAddr_del(rtk_mac_t *pMac, unsigned int ivl, unsigned int cvid_fid);
 ...
 */
extern int rtk_l2_ipMcastAddr_add(unsigned int sip, unsigned int dip, rtk_portmask_t portmask);
 ...
 */
extern int rtk_l2_ipMcastAddr_get(unsigned int sip, unsigned int dip, rtk_portmask_t *pPortmask);
 ...
 */
extern int rtk_l2_ipMcastAddr_next_get(unsigned int *pAddress, unsigned int *pSip, unsigned int *pDip, rtk_portmask_t *pPortmask);
 ...
 */
extern int rtk_l2_ipMcastAddr_del(unsigned int sip, unsigned int dip);
 ...
 */
extern int rtk_l2_flushType_set(rtk_l2_flushType_t type, rtk_vlan_t vid, unsigned int portOrTid);
 ...
 */
extern int rtk_l2_ucastAddr_flush(rtk_l2_flushCfg_t *pConfig);
 ...
 *      - ENABLED
 */
extern int rtk_l2_flushLinkDownPortAddrEnable_set(unsigned int port, rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern int rtk_l2_flushLinkDownPortAddrEnable_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_l2_agingEnable_set(unsigned int port, rtk_enable_t enable);
 ...
 */
extern int rtk_l2_agingEnable_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 *      to 8k.
 */
extern int rtk_l2_limitLearningCnt_set(unsigned int port, rtk_mac_cnt_t mac_cnt);
 ...
 */
extern int rtk_l2_limitLearningCnt_get(unsigned int port, rtk_mac_cnt_t *pMac_cnt);
 ...
 */
extern int rtk_l2_limitLearningCntAction_set(unsigned int port, rtk_l2_limitLearnCntAction_t action);
 ...
 *      - LIMIT_LEARN_CNT_ACTION_TO_CPU,
 */
extern int rtk_l2_limitLearningCntAction_get(unsigned int port, rtk_l2_limitLearnCntAction_t *pAction);
 ...
 */
extern int rtk_l2_learningCnt_get(unsigned int port, rtk_mac_cnt_t *pMac_cnt);
 ...
 *      - FLOOD_BC
 */
extern int rtk_l2_floodPortMask_set(rtk_l2_flood_type_t floood_type, rtk_portmask_t flood_portmask);
 ...
 *      - FLOOD_BC
 */
extern int rtk_l2_floodPortMask_get(rtk_l2_flood_type_t floood_type, rtk_portmask_t *pFlood_portmask);
 ...
 */
extern int rtk_l2_localPktPermit_set(unsigned int port, rtk_enable_t permit);
 ...
 */
extern int rtk_l2_localPktPermit_get(unsigned int port, rtk_enable_t *pPermit);
 ...
 */
extern int rtk_l2_aging_set(unsigned int aging_time);
 ...
 */
extern int rtk_l2_aging_get(unsigned int *pAging_time);
 ...
 */
extern int rtk_l2_ipMcastAddrLookup_set(rtk_l2_lookup_type_t type);
 ...
 *      None.
 */
extern int rtk_l2_ipMcastAddrLookup_get(rtk_l2_lookup_type_t *pType);
 ...
 */
extern int rtk_l2_ipMcastAddrLookupException_add(unsigned int ip_addr);
 ...
 */
extern int rtk_l2_ipMcastAddrLookupException_del(unsigned int ip_addr);
 ...
 */
extern int rtk_l2_entry_get(rtk_l2_addr_table_t *pL2_entry);
 ...
 */
extern int rtk_svlan_init(void);
 ...
 */
extern int rtk_svlan_servicePort_add(unsigned int port);
 ...
 *      contain accept SVID in S-tag field.
 */
extern int rtk_svlan_servicePort_get(rtk_portmask_t *pSvlan_portmask);
 ...
 */
extern int rtk_svlan_servicePort_del(unsigned int port);
 ...
 *      User can set mathced ether type as service provider supported protocol.
 */
extern int rtk_svlan_tpidEntry_set(unsigned int svlan_tag_id);
 ...
 *      contain accept SVID in S-tag field.
 */
extern int rtk_svlan_tpidEntry_get(unsigned int *pSvlan_tag_id);
 ...
 *      - REF_SVLAN_PRI.
 */
extern int rtk_svlan_priorityRef_set(rtk_svlan_pri_ref_t ref);
 ...
 *      - REF_SVLAN_PRI.
 */
extern int rtk_svlan_priorityRef_get(rtk_svlan_pri_ref_t *pRef);
 ...
 */
extern int rtk_svlan_memberPortEntry_set(unsigned int svid_idx, rtk_svlan_memberCfg_t *psvlan_cfg);
 ...
 */
extern int rtk_svlan_memberPortEntry_get(unsigned int svid_idx, rtk_svlan_memberCfg_t *pSvlan_cfg);
 ...
 *      - rtk_svlan_memberCfg_t->priority is priority of SVLAN member configuration.
 */
extern int rtk_svlan_memberPortEntry_adv_set(unsigned int idx, rtk_svlan_memberCfg_t *pSvlan_cfg);
 ...
 *      to receiving from uplink ports. Other SVID S-tag frame or S-untagged frame will be droped.
 */
extern int rtk_svlan_memberPortEntry_adv_get(unsigned int idx, rtk_svlan_memberCfg_t *pSvlan_cfg);
 ...
 */
extern int rtk_svlan_defaultSvlan_set(unsigned int port, rtk_vlan_t svid);
 ...
 *      is transmit through uplink port with s-tag field
 */
extern int rtk_svlan_defaultSvlan_get(unsigned int port, rtk_vlan_t *pSvid);
 ...
 */
extern int rtk_svlan_c2s_add(rtk_vlan_t vid, unsigned int src_port, rtk_vlan_t svid);
 ...
 */
extern int rtk_svlan_c2s_del(rtk_vlan_t vid, unsigned int src_port);
 ...
 */
extern int rtk_svlan_c2s_get(rtk_vlan_t vid, unsigned int src_port, rtk_vlan_t *pSvid);
 ...
 */
extern int rtk_svlan_untag_action_set(rtk_svlan_untag_action_t action, rtk_vlan_t svid);
 ...
 */
extern int rtk_svlan_untag_action_get(rtk_svlan_untag_action_t *pAction, rtk_vlan_t *pSvid);
 ...
 */
extern int rtk_svlan_unmatch_action_set(rtk_svlan_unmatch_action_t action, rtk_vlan_t svid);
 ...
 */
extern int rtk_svlan_unmatch_action_get(rtk_svlan_unmatch_action_t *pAction, rtk_vlan_t *pSvid);
 ...
 */
extern int rtk_svlan_dmac_vidsel_set(unsigned int port, rtk_enable_t enable);
 ...
 */
extern int rtk_svlan_dmac_vidsel_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_svlan_ipmc2s_add(unsigned int ipmc, rtk_vlan_t svid);
 ...
 */
extern int rtk_svlan_ipmc2s_del(unsigned int ipmc);
 ...
 */
extern int rtk_svlan_ipmc2s_get(unsigned int ipmc, rtk_vlan_t *pSvid);
 ...
 */
extern int rtk_svlan_l2mc2s_add(rtk_vlan_t svid, rtk_mac_t mac);
 ...
 */
extern int rtk_svlan_l2mc2s_del(rtk_mac_t mac);
 ...
 */
extern int rtk_svlan_l2mc2s_get(rtk_mac_t mac, rtk_vlan_t *pSvid);
 ...
 */
extern int rtk_svlan_sp2c_add(rtk_vlan_t svid, unsigned int dst_port, rtk_vlan_t cvid);
 ...
 */
extern int rtk_svlan_sp2c_get(rtk_vlan_t svid, unsigned int dst_port, rtk_vlan_t *pCvid);
 ...
 */
extern int rtk_svlan_sp2c_del(rtk_vlan_t svid, unsigned int dst_port);
 ...
 */
extern int rtk_cpu_enable_set(rtk_enable_t enable);
 ...
 */
extern int rtk_cpu_enable_get(rtk_enable_t *pEnable);
 ...
 *      - CPU_INSERT_TO_NONE
 */
extern int rtk_cpu_tagPort_set(unsigned int port, rtk_cpu_insert_t mode);
 ...
 *      - CPU_INSERT_TO_NONE
 */
extern int rtk_cpu_tagPort_get(unsigned int *pPort, rtk_cpu_insert_t *pMode);
 ...
 */
extern int rtk_dot1x_unauthPacketOper_set(unsigned int port, rtk_dot1x_unauth_action_t unauth_action);
 ...
 *      - DOT1X_ACTION_GUESTVLAN
 */
extern int rtk_dot1x_unauthPacketOper_get(unsigned int port, rtk_dot1x_unauth_action_t *pUnauth_action);
 ...
 *      - ENABLED
 */
extern int rtk_dot1x_eapolFrame2CpuEnable_set(rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern int rtk_dot1x_eapolFrame2CpuEnable_get(rtk_enable_t *pEnable);
 ...
 *      - ENABLED
 */
extern int rtk_dot1x_portBasedEnable_set(unsigned int port, rtk_enable_t enable);
 ...
 */
extern int rtk_dot1x_portBasedEnable_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 *      - AUTH
 */
extern int rtk_dot1x_portBasedAuthStatus_set(unsigned int port, rtk_dot1x_auth_status_t port_auth);
 ...
 */
extern int rtk_dot1x_portBasedAuthStatus_get(unsigned int port, rtk_dot1x_auth_status_t *pPort_auth);
 ...
 *      - IN
 */
extern int rtk_dot1x_portBasedDirection_set(unsigned int port, rtk_dot1x_direction_t port_direction);
 ...
 */
extern int rtk_dot1x_portBasedDirection_get(unsigned int port, rtk_dot1x_direction_t *pPort_direction);
 ...
 *      - ENABLED
 */
extern int rtk_dot1x_macBasedEnable_set(unsigned int port, rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern int rtk_dot1x_macBasedEnable_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 */
extern int rtk_dot1x_macBasedAuthMac_add(unsigned int port, rtk_mac_t *pAuth_mac, unsigned int fid);
 ...
 */
extern int rtk_dot1x_macBasedAuthMac_del(unsigned int port, rtk_mac_t *pAuth_mac, unsigned int fid);
 ...
 *      - IN
 */
extern int rtk_dot1x_macBasedDirection_set(rtk_dot1x_direction_t mac_direction);
 ...
 */
extern int rtk_dot1x_macBasedDirection_get(rtk_dot1x_direction_t *pMac_direction);
 ...
 */
extern int rtk_dot1x_guestVlan_set(rtk_vlan_t vid);
 ...
 */
extern int rtk_dot1x_guestVlan_get(rtk_vlan_t *pVid);
 ...
 *      - DISABLED
 */
extern int rtk_dot1x_guestVlan2Auth_set(rtk_enable_t enable);
 ...
 */
extern int rtk_dot1x_guestVlan2Auth_get(rtk_enable_t *pEnable);
 ...
 */
extern int rtk_trunk_port_set(rtk_trunk_group_t trk_gid, rtk_portmask_t trunk_member_portmask);
 ...
 *      - TRUNK_GROUP1: port 4 to port 7.
 */
extern int rtk_trunk_port_get(rtk_trunk_group_t trk_gid, rtk_portmask_t *pTrunk_member_portmask);
 ...
 */
extern int rtk_trunk_distributionAlgorithm_set(rtk_trunk_group_t trk_gid, rtk_trunk_hashVal2Port_t algo_bitmask);
 ...
 */
extern int rtk_trunk_distributionAlgorithm_get(rtk_trunk_group_t trk_gid, rtk_trunk_hashVal2Port_t *pAlgo_bitmask);
 ...
 */
extern int rtk_trunk_qeueuEmptyStatus_get(rtk_portmask_t *pPortmask);
 ...
 *      should be identical.
 */
extern int rtk_mirror_portBased_set(unsigned int mirroring_port, rtk_portmask_t *pMirrored_rx_portmask, rtk_portmask_t *pMirrored_tx_portmask);
 ...
 */
extern int rtk_mirror_portBased_get(unsigned int* pMirroring_port, rtk_portmask_t *pMirrored_rx_portmask, rtk_portmask_t *pMirrored_tx_portmask);
 ...
 */
extern int rtk_mirror_portIso_set(rtk_enable_t enable);
 ...
 */
extern int rtk_mirror_portIso_get(rtk_enable_t *pEnable);

/* MIB */
#ifdef EMBEDDED_SUPPORT
extern int rtk_stat_global_reset(void);
extern int rtk_stat_port_reset(unsigned int port);
extern int rtk_stat_port_get(unsigned int port, rtk_stat_port_type_t cntr_idx, rtk_stat_counter_t *pCntrH, rtk_stat_counter_t *pCntrL);
extern int rtk_stat_global_get(rtk_stat_global_type_t cntr_idx, rtk_stat_counter_t *pCntrH, rtk_stat_counter_t *pCntrL);
#else
 ...
 */
extern int rtk_stat_global_get(rtk_stat_global_type_t cntr_idx, rtk_stat_counter_t *pCntr);
 ...
 */
extern int rtk_stat_global_getAll(rtk_stat_global_cntr_t *pGlobal_cntrs);
 ...
 */
extern int rtk_stat_port_get(unsigned int port, rtk_stat_port_type_t cntr_idx, rtk_stat_counter_t *pCntr);
 ...
 */
extern int rtk_stat_port_getAll(unsigned int port, rtk_stat_port_cntr_t *pPort_cntrs);
#endif
 ...
 *      Set the type and mode of Logging Counter.
 */
extern int rtk_stat_logging_counterCfg_set(unsigned int idx, rtk_logging_counter_mode_t mode, rtk_logging_counter_type_t type);
 ...
 *      Get the type and mode of Logging Counter.
 */
extern int rtk_stat_logging_counterCfg_get(unsigned int idx, rtk_logging_counter_mode_t *pMode, rtk_logging_counter_type_t *pType);
 ...
 *      Reset Logging Counter.
 */
extern int rtk_stat_logging_counter_reset(unsigned int idx);
 ...
 *      Get Logging Counter.
 */
extern int rtk_stat_logging_counter_get(unsigned int idx, unsigned int *pCnt);
 ...
 */
extern int rtk_int_polarity_set(rtk_int_polarity_t type);
 ...
 */
extern int rtk_int_polarity_get(rtk_int_polarity_t *pType);
 ...
 *      - INT_TYPE_SLIENT
 */
extern int rtk_int_control_set(rtk_int_type_t type, rtk_enable_t enable);
 ...
 *      - INT_TYPE_SLIENT
 */
extern int rtk_int_control_get(rtk_int_type_t type, rtk_enable_t* pEnable);
 ...
 */
extern int rtk_int_status_set(rtk_int_status_t statusMask);
 ...
 *
 */
extern int rtk_int_status_get(rtk_int_status_t* pStatusMask);
 ...
 *      The status will be cleared after execute this API.
 */
extern int rtk_int_advanceInfo_get(rtk_int_advType_t adv_type, unsigned int *info);
 ...
 */
extern int rtk_led_enable_set(rtk_led_group_t group, rtk_portmask_t portmask);
 ...
 */
extern int rtk_led_enable_get(rtk_led_group_t group, rtk_portmask_t *pPortmask);
 ...
 *      - LED_OP_SERIAL,
 */
extern int rtk_led_operation_set(rtk_led_operation_t mode);
 ...
 *      - LED_OP_SERIAL,
 */
extern int rtk_led_operation_get(rtk_led_operation_t *pMode);
 ...
 */
extern int rtk_led_mode_set(rtk_led_mode_t mode);
 ...
 */
extern int rtk_led_mode_get(rtk_led_mode_t *pMode);
 ...
 *      - LED_FORCE_ON.
 */
extern int rtk_led_modeForce_set(rtk_led_group_t group, rtk_led_force_mode_t mode);
 ...
 *      - LED_FORCE_ON.
 */
extern int rtk_led_modeForce_get(rtk_led_group_t group, rtk_led_force_mode_t *pMode);
 ...
 */
extern int rtk_led_blinkRate_set(rtk_led_blink_rate_t blinkRate);
 ...
 */
extern int rtk_led_blinkRate_get(rtk_led_blink_rate_t *pBlinkRate);
 ...
 */
extern int rtk_led_groupConfig_set(rtk_led_group_t group, rtk_led_congig_t config);
 ...
 */
extern int rtk_led_groupConfig_get(rtk_led_group_t group, rtk_led_congig_t *pConfig);
 ...
 */
extern int rtk_led_serialMode_set(rtk_led_active_t active);
 ...
 */
extern int rtk_led_serialMode_get(rtk_led_active_t *pActive);
 ...
 */
extern int rtk_filter_igrAcl_field_add(rtk_filter_cfg_t *pFilter_cfg, rtk_filter_field_t *pFilter_field);
 ...
 */
extern int rtk_filter_igrAcl_cfg_add(unsigned int filter_id, rtk_filter_cfg_t *pFilter_cfg, rtk_filter_action_t *pAction, rtk_filter_number_t *ruleNum);
 ...
 */
extern int rtk_filter_igrAcl_cfg_del(unsigned int filter_id);
 ...
 */
extern int rtk_filter_igrAcl_cfg_delAll(void);
 ...
 *      This function delete all ACL configuration from ASIC.
 */
extern int rtk_filter_igrAcl_cfg_get(unsigned int filter_id, rtk_filter_cfg_raw_t *pFilter_cfg, rtk_filter_action_t *pAction);
 ...
 */
extern int rtk_filter_igrAcl_unmatchAction_set(unsigned int port, unsigned int action);
 ...
 */
extern int rtk_filter_igrAcl_unmatchAction_get(unsigned int port, unsigned int* action);
 ...
 *      This function gets action of packets when no ACL configruation matches.
 */
extern int rtk_filter_igrAcl_state_set(unsigned int port, unsigned int state);
 ...
 *      This function gets action of packets when no ACL configruation matches.
 */
extern int rtk_filter_igrAcl_state_get(unsigned int port, unsigned int* state);
 ...
 */
extern int rtk_filter_igrAcl_template_set(rtk_filter_template_t *aclTemplate);
 ...
 */
extern int rtk_filter_igrAcl_template_get(rtk_filter_template_t *aclTemplate);
 ...
 */
extern int rtk_filter_igrAcl_field_sel_set(unsigned int index, rtk_field_sel_t format, unsigned int offset);
 ...
 *      None.
 */
extern int rtk_filter_igrAcl_field_sel_get(unsigned int index, rtk_field_sel_t *pFormat, unsigned int *pOffset);
 ...
 */
extern int rtk_filter_iprange_set(unsigned int index, rtk_filter_iprange_t type, unsigned int upperIp, unsigned int lowerIp);
 ...
 *      upperIp must be larger or equal than lowerIp.
 */
extern int rtk_filter_iprange_get(unsigned int index, rtk_filter_iprange_t *pType, unsigned int *pUpperIp, unsigned int *pLowerIp);
 ...
 */
extern int rtk_filter_vidrange_set(unsigned int index, rtk_filter_vidrange_t type, unsigned int upperVid, unsigned int lowerVid);
 ...
 *      None.
 */
extern int rtk_filter_vidrange_get(unsigned int index, rtk_filter_vidrange_t *pType, unsigned int *pUpperVid, unsigned int *pLowerVid);
 ...
 */
extern int rtk_filter_portrange_set(unsigned int index, rtk_filter_portrange_t type, unsigned int upperPort, unsigned int lowerPort);
 ...
 *      None.
 */
extern int rtk_filter_portrange_get(unsigned int index, rtk_filter_portrange_t *pType, unsigned int *pUpperPort, unsigned int *pLowerPort);
 ...
 *      - ENABLE
 */
extern int rtk_eee_portEnable_set(unsigned int port, rtk_enable_t enable);
 ...
 *      - ENABLE
 */
extern int rtk_eee_portEnable_get(unsigned int port, rtk_enable_t *pEnable);
 ...
 *      This API set H/W IGMP state.
 */
extern int rtk_igmp_state_set(rtk_enable_t enabled);
 ...
 */
extern int rtk_igmp_state_get(rtk_enable_t *pEnabled);
 ...
 */
extern int rtk_igmp_static_router_port_set(rtk_portmask_t portmask);
 ...
 */
extern int rtk_igmp_static_router_port_get(rtk_portmask_t *pPortmask);
 ...
 */
extern int rtk_igmp_protocol_set(unsigned int port, rtk_igmp_protocol_t protocol, rtk_trap_igmp_action_t action);
 ...
 *      This API set IGMP/MLD protocol action
 */
extern int rtk_igmp_protocol_get(unsigned int port, rtk_igmp_protocol_t protocol, rtk_trap_igmp_action_t *pAction);
 ...
 */
extern int rtk_igmp_fastLeave_set(rtk_enable_t state);
 ...
 */
extern int rtk_igmp_fastLeave_get(rtk_enable_t *pState);
 ...
 */
extern int rtk_igmp_maxGroup_set(unsigned int port, unsigned int group);
 ...
 */
extern int rtk_igmp_maxGroup_get(unsigned int port, unsigned int *pGroup);
 ...
 */
extern int rtk_igmp_currentGroup_get(unsigned int port, unsigned int *pGroup);
