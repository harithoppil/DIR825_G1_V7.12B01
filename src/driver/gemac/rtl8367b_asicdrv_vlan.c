 ...
 *      None
 */
int rtl8367b_setAsicVlanMemberConfig(unsigned int index, rtl8367b_vlanconfiguser *pVlanCg)
{
	int  retVal;
    ...
    tableAddr = (unsigned short*)&smi_vlancfg;
 ...
 *      None
 */
int rtl8367b_getAsicVlanMemberConfig(unsigned int index, rtl8367b_vlanconfiguser *pVlanCg)
{
    int  retVal;
    unsigned int page_idx;
    unsigned int regAddr;
    ...
    for(page_idx = 0; page_idx < 4; page_idx++)  /* 4 pages per VLAN Member Config */
    {
        ...
        *tableAddr = (unsigned short)regData;
        tableAddr++;
    }
 ...
 *      None
 */
int rtl8367b_setAsicVlan4kEntry(rtl8367b_user_vlan4kentry *pVlan4kEntry )
{
	...
	/* Prepare Data */
	tableAddr = (unsigned short *)&vlan_4k_entry;
 ...
 *      None
 */
int rtl8367b_getAsicVlan4kEntry(rtl8367b_user_vlan4kentry *pVlan4kEntry )
{
#if defined(DISABLE_VLAN_SHADOW)
	rtl8367b_vlan4kentrysmi vlan_4k_entry;
	unsigned int					page_idx;
 ...
 *      None
 */
int rtl8367b_setAsicVlanAccpetFrameType(unsigned int port, rtl8367b_accframetype frameType)
{
 ...
 *      None
 */
int rtl8367b_getAsicVlanAccpetFrameType(unsigned int port, rtl8367b_accframetype *pFrameType)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicVlanIngressFilter(unsigned int port, unsigned int enabled)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicVlanIngressFilter(unsigned int port, unsigned int *pEnable)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicVlanEgressTagMode(unsigned int port, rtl8367b_egtagmode tagMode)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicVlanEgressTagMode(unsigned int port, rtl8367b_egtagmode *pTagMode)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicVlanPortBasedVID(unsigned int port, unsigned int index, unsigned int pri)
{
    unsigned int regAddr, bit_mask;
    int  retVal;
 ...
 *      None
 */
int rtl8367b_getAsicVlanPortBasedVID(unsigned int port, unsigned int *pIndex, unsigned int *pPri)
{
    unsigned int regAddr,bit_mask;
    int  retVal;
 ...
 *      None
 */
int rtl8367b_setAsicVlanProtocolBasedGroupData(unsigned int index, rtl8367b_protocolgdatacfg *pPbCfg)
{
 ...
 *      None
 */
int rtl8367b_getAsicVlanProtocolBasedGroupData(unsigned int index, rtl8367b_protocolgdatacfg *pPbCfg)
{
	unsigned int  frameType;
    unsigned int  etherType;
	int	retVal;
 ...
 *      None
 */
int rtl8367b_setAsicVlanPortAndProtocolBased(unsigned int port, unsigned int index, rtl8367b_protocolvlancfg *pPpbCfg)
{
	unsigned int  reg_addr, bit_mask, bit_value;
	int   retVal;
 ...
 *      None
 */
int rtl8367b_getAsicVlanPortAndProtocolBased(unsigned int port, unsigned int index, rtl8367b_protocolvlancfg *pPpbCfg)
{
	unsigned int  reg_addr, bit_mask, bit_value;
	int   retVal;
 ...
 *      None
 */
int rtl8367b_setAsicVlanFilter(unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicVlanFilter(unsigned int* pEnabled)
{
 ...
 *      None
 */
int rtl8367b_setAsicVlanUntagDscpPriorityEn(unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicVlanUntagDscpPriorityEn(unsigned int* enabled)
{
 ...
 *      None
 */
int rtl8367b_setAsicPortBasedFid(unsigned int port, unsigned int fid)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicPortBasedFid(unsigned int port, unsigned int* pFid)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicPortBasedFidEn(unsigned int port, unsigned int enabled)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicPortBasedFidEn(unsigned int port, unsigned int* pEnabled)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicSpanningTreeStatus(unsigned int port, unsigned int msti, unsigned int state)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicSpanningTreeStatus(unsigned int port, unsigned int msti, unsigned int* pState)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicVlanTransparent(unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicVlanTransparent(unsigned int* pEnabled)
{
 ...
 *      None
 */
int rtl8367b_setAsicVlanEgressKeep(unsigned int port, unsigned int portmask)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicVlanEgressKeep(unsigned int port, unsigned int* pPortmask)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
