 ...
 *      None
 */
int rtl8367b_setAsicPortIsolationPermittedPortmask(unsigned int port, unsigned int permitPortmask)
{
 ...
 *      None
 */
int rtl8367b_getAsicPortIsolationPermittedPortmask(unsigned int port, unsigned int *pPermitPortmask)
{
    if(port >= RTL8367B_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 */
int rtl8367b_setAsicPortIsolationEfid(unsigned int port, unsigned int efid)
{
    if(port >= RTL8367B_PORTNO)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicPortIsolationEfid(unsigned int port, unsigned int *pEfid)
{
    if(port >= RTL8367B_PORTNO)
        return RT_ERR_PORT_ID;
