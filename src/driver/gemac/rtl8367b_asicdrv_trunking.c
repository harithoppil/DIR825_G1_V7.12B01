 ...
 *      None
 */
int rtl8367b_setAsicTrunkingMode(unsigned int mode)
{
 ...
 *      None
 */
int rtl8367b_getAsicTrunkingMode(unsigned int* pMode)
{
 ...
 *      None
 */
int rtl8367b_setAsicTrunkingFc(unsigned int group, unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicTrunkingFc(unsigned int group, unsigned int* pEnabled)
{
    if(group > RTL8367B_MAX_TRUNK_GID)
        return RT_ERR_LA_TRUNK_ID;
 ...
 *      None
 */
int rtl8367b_setAsicTrunkingGroup(unsigned int group, unsigned int portmask)
{
    if(group > RTL8367B_MAX_TRUNK_GID)
        return RT_ERR_LA_TRUNK_ID;
 ...
 *      None
 */
int rtl8367b_getAsicTrunkingGroup(unsigned int group, unsigned int* pPortmask)
{
    if(group > RTL8367B_MAX_TRUNK_GID)
        return RT_ERR_LA_TRUNK_ID;
 ...
 *      None
 */
int rtl8367b_setAsicTrunkingFlood(unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicTrunkingFlood(unsigned int* pEnabled)
{
 ...
 */
int rtl8367b_setAsicTrunkingHashSelect(unsigned int hashsel)
{
 ...
 *    	None
 */
int rtl8367b_getAsicTrunkingHashSelect(unsigned int* pHashsel)
{
 ...
 *    	None
 */
int rtl8367b_getAsicQeueuEmptyStatus(unsigned int* portmask)
{
 ...
 *    	None
 */
int rtl8367b_setAsicTrunkingHashTable(unsigned int hashval, unsigned int portId)
{
 ...
 *    	None
 */
int rtl8367b_getAsicTrunkingHashTable(unsigned int hashval, unsigned int* pPortId)
{
	if(hashval > RTL8367B_TRUNKING_HASHVALUE_MAX)
		return RT_ERR_OUT_OF_RANGE;
