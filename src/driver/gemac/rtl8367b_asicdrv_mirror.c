 ...
 *      None
 */
int rtl8367b_setAsicPortMirror(unsigned int source, unsigned int monitor)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicPortMirror(unsigned int *pSource, unsigned int *pMonitor)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_setAsicPortMirrorRxFunction(unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicPortMirrorRxFunction(unsigned int* pEnabled)
{
 ...
 *      None
 */
int rtl8367b_setAsicPortMirrorTxFunction(unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicPortMirrorTxFunction(unsigned int* pEnabled)
{
 ...
 *      None
 */
int rtl8367b_setAsicPortMirrorIsolation(unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicPortMirrorIsolation(unsigned int* pEnabled)
{
 ...
 *      None
 */
int rtl8367b_setAsicPortMirrorMask(unsigned int SourcePortmask)
{
 ...
 *      None
 */
int rtl8367b_getAsicPortMirrorMask(unsigned int *pSourcePortmask)
{
