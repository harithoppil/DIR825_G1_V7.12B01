 ...
 *      None
 */
int rtl8367b_setAsicInterruptPolarity(unsigned int polarity)
{
 ...
 *      None
 */
int rtl8367b_getAsicInterruptPolarity(unsigned int* pPolarity)
{
 ...
 *      None
 */
int rtl8367b_setAsicInterruptMask(unsigned int imr)
{
 ...
 *      None
 */
int rtl8367b_getAsicInterruptMask(unsigned int* pImr)
{
 ...
 *    	[10]:UPS event
 */
int rtl8367b_setAsicInterruptStatus(unsigned int ims)
{
 ...
 *   	None
 */
int rtl8367b_getAsicInterruptStatus(unsigned int* pIms)
{
 ...
 *   	None
 */
int rtl8367b_setAsicInterruptRelatedStatus(unsigned int type, unsigned int status)
{
    const unsigned int indicatorAddress[INTRST_END] = {RTL8367B_REG_LEARN_OVER_INDICATOR,
 ...
 *   	None
 */
int rtl8367b_getAsicInterruptRelatedStatus(unsigned int type, unsigned int* pStatus)
{
    const unsigned int indicatorAddress[INTRST_END] = {RTL8367B_REG_LEARN_OVER_INDICATOR,
													RTL8367B_REG_SPEED_CHANGE_INDICATOR,
													RTL8367B_REG_SPECIAL_CONGEST_INDICATOR,
