 ...
 *      None
 */
int rtl8367b_setAsicSvlanUplinkPortMask(unsigned int portMask)
{
 ...
 *      None
 */
int rtl8367b_getAsicSvlanUplinkPortMask(unsigned int* pPortmask)
{
 ...
 */
int rtl8367b_setAsicSvlanTpid(unsigned int protocolType)
{
 ...
 *      None
 */
int rtl8367b_getAsicSvlanTpid(unsigned int* pProtocolType)
{
 ...
 *      None
 */
int rtl8367b_setAsicSvlanPrioritySel(unsigned int priSel)
{
 ...
 *      None
 */
int rtl8367b_getAsicSvlanPrioritySel(unsigned int* pPriSel)
{
 ...
 *      None
 */
int rtl8367b_setAsicSvlanTrapPriority(unsigned int priority)
{
 ...
 *      None
 */
int rtl8367b_getAsicSvlanTrapPriority(unsigned int* pPriority)
{
 ...
 *      None
 */
int rtl8367b_setAsicSvlanDefaultVlan(unsigned int port, unsigned int index)
{
    int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicSvlanDefaultVlan(unsigned int port, unsigned int* pIndex)
{
    int retVal;
 ...
 *      None
 */
int rtl8367b_setAsicSvlanIngressUntag(unsigned int mode)
{
 ...
 *      None
 */
int rtl8367b_getAsicSvlanIngressUntag(unsigned int* pMode)
{
 ...
 *      None
 */
int rtl8367b_setAsicSvlanIngressUnmatch(unsigned int mode)
{
 ...
 *      None
 */
int rtl8367b_getAsicSvlanIngressUnmatch(unsigned int* pMode)
{
 ...
 *      None
 */
int rtl8367b_setAsicSvlanEgressUnassign(unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicSvlanEgressUnassign(unsigned int* pEnabled)
{
 ...
 *      None
 */
int rtl8367b_setAsicSvlanMemberConfiguration(unsigned int index, rtl8367b_svlan_memconf_t* pSvlanMemCfg)
{
    int retVal;
    ...
    accessPtr = (unsigned short*)&smiSvlanMemConf;
 ...
 *      None
 */
int rtl8367b_getAsicSvlanMemberConfiguration(unsigned int index,rtl8367b_svlan_memconf_t* pSvlanMemCfg)
{
    int retVal;
    unsigned int regData;
    unsigned short *accessPtr;
 ...
 */
int rtl8367b_setAsicSvlanC2SConf(unsigned int index, unsigned int evid, unsigned int portmask, unsigned int svidx)
{
    int retVal;
    unsigned int regData;
    unsigned short *accessPtr;
    ...
    accessPtr =  (unsigned short*)&smiSvlanC2SConf;
 ...
 *      None
 */
int rtl8367b_getAsicSvlanC2SConf(unsigned int index, unsigned int* pEvid, unsigned int* pPortmask, unsigned int* pSvidx)
{
    int retVal;
    unsigned int regData;
    unsigned short *accessPtr;
    ...
    for(i = 0; i < 3; i++)
    {
        ...
        *accessPtr = (unsigned short)regData;
 ...
 */
int rtl8367b_setAsicSvlanMC2SConf(unsigned int index,rtl8367b_svlan_mc2s_t* pSvlanMc2sCfg)
{
    int retVal;
    unsigned int regData;
    unsigned short *accessPtr;
    ...
    accessPtr =  (unsigned short*)&smiSvlanMC2S;
 ...
 *      None
 */
int rtl8367b_getAsicSvlanMC2SConf(unsigned int index, rtl8367b_svlan_mc2s_t* pSvlanMc2sCfg)
{
    int retVal;
    unsigned int regData;
    unsigned short *accessPtr;
 ...
 *      None
 */
int rtl8367b_setAsicSvlanSP2CConf(unsigned int index, rtl8367b_svlan_s2c_t* pSvlanSp2cCfg)
{
    int retVal;
    unsigned int regData;
    unsigned short *accessPtr;
    ...
    accessPtr = (unsigned short*)&smiSvlanSP2C;
 ...
 *      None
 */
int rtl8367b_getAsicSvlanSP2CConf(unsigned int index,rtl8367b_svlan_s2c_t* pSvlanSp2cCfg)
{
    int retVal;
    unsigned int regData;
    unsigned short *accessPtr;
 ...
 *      None
 */
int rtl8367b_setAsicSvlanDmacCvidSel(unsigned int port, unsigned int enabled)
{
	if(port > RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicSvlanDmacCvidSel(unsigned int port, unsigned int* pEnabled)
{
	if(port > RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicSvlanUntagVlan(unsigned int index)
{
    if(index > RTL8367B_SVIDXMAX)
        return RT_ERR_SVLAN_ENTRY_INDEX;
 ...
 *      None
 */
int rtl8367b_getAsicSvlanUntagVlan(unsigned int* pIndex)
{
 ...
 *      None
 */
int rtl8367b_setAsicSvlanUnmatchVlan(unsigned int index)
{
    if(index > RTL8367B_SVIDXMAX)
        return RT_ERR_SVLAN_ENTRY_INDEX;
 ...
 *      None
 */
int rtl8367b_getAsicSvlanUnmatchVlan(unsigned int* pIndex)
{
