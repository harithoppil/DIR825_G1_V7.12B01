 ...
 *      None
 */
int rtl8367b_setAsicLutIpMulticastLookup(unsigned int enabled)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutIpMulticastLookup(unsigned int* pEnabled)
{
 ...
 *      None
 */
int rtl8367b_setAsicLutIpLookupMethod(unsigned int type)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutIpLookupMethod(unsigned int* pType)
{
 ...
 *      None
 */
int rtl8367b_setAsicLutAgeTimerSpeed(unsigned int timer, unsigned int speed)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutAgeTimerSpeed(unsigned int* pTimer, unsigned int* pSpeed)
{
 ...
 *      None
 */
int rtl8367b_setAsicLutCamTbUsage(unsigned int enabled)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicLutCamTbUsage(unsigned int* pEnabled)
{
	int       retVal;
    unsigned int  regData;
 ...
 *      None
 */
int rtl8367b_setAsicLutLearnLimitNo(unsigned int port, unsigned int number)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutLearnLimitNo(unsigned int port, unsigned int* pNumber)
{
    if(port > RTL8367B_PORTIDMAX)
        return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicLutLearnOverAct(unsigned int action)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutLearnOverAct(unsigned int* pAction)
{
 ...
 *      None
 */
int rtl8367b_setAsicL2LookupTb(rtl8367b_luttb *pL2Table)
{
	int retVal;
	unsigned int regData;
	...
	accessPtr =  (unsigned short*)&smil2Table;
	regData = *accessPtr;
 ...
 *      None
 */
int rtl8367b_getAsicL2LookupTb(unsigned int method, rtl8367b_luttb *pL2Table)
{
	int retVal;
	unsigned int regData;
	unsigned short* accessPtr;
 ...
 *      None
 */
int rtl8367b_getAsicLutLearnNo(unsigned int port, unsigned int* pNumber)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_setAsicLutForceFlush(unsigned int portmask)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutForceFlushStatus(unsigned int *pPortmask)
{
 ...
 *      None
 */
int rtl8367b_setAsicLutFlushMode(unsigned int mode)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutFlushMode(unsigned int* pMode)
{
 ...
 *      None
 */
int rtl8367b_setAsicLutFlushType(unsigned int type)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutFlushType(unsigned int* pType)
{
 ...
 *      None
 */
int rtl8367b_setAsicLutFlushVid(unsigned int vid)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutFlushVid(unsigned int* pVid)
{
 ...
 *      None
 */
int rtl8367b_setAsicLutFlushFid(unsigned int fid)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutFlushFid(unsigned int* pFid)
{
 ...
 *      None
 */
int rtl8367b_setAsicLutDisableAging(unsigned int port, unsigned int disabled)
{
	if(port > RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicLutDisableAging(unsigned int port, unsigned int *pDisabled)
{
	if(port > RTL8367B_PORTIDMAX)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicLutIPMCGroup(unsigned int index, unsigned int group_addr)
{
 ...
 *      None
 */
int rtl8367b_getAsicLutIPMCGroup(unsigned int index, unsigned int *pGroup_addr)
{
    unsigned int      regAddr, regData;
    unsigned int    ipData;
    int       retVal;
 ...
 *      None
 */
int rtl8367b_setAsicLutLinkDownForceAging(unsigned int enable)
{
    if(enable > 1)
 ...
 *      None
 */
int rtl8367b_getAsicLutLinkDownForceAging(unsigned int *pEnable)
{
    unsigned int  value;
    int   retVal;
