 ...
 *      None
 */
int rtl8367b_setAsicPortUnknownDaBehavior(unsigned int behavior)
{
 ...
 *      None
 */
int rtl8367b_getAsicPortUnknownDaBehavior(unsigned int *pBehavior)
{
 ...
 *      None
 */
int rtl8367b_setAsicPortUnknownSaBehavior(unsigned int behavior)
{
 ...
 *      None
 */
int rtl8367b_getAsicPortUnknownSaBehavior(unsigned int *pBehavior)
{
 ...
 *      None
 */
int rtl8367b_setAsicPortUnmatchedSaBehavior(unsigned int behavior)
{
    if(behavior >= L2_BEHAVE_SA_END)
		return RT_ERR_NOT_ALLOWED;
 ...
 *      None
 */
int rtl8367b_getAsicPortUnmatchedSaBehavior(unsigned int *pBehavior)
{
 ...
 *      None
 */
int rtl8367b_setAsicPortUnknownDaFloodingPortmask(unsigned int portmask)
{
 ...
 *      None
 */
int rtl8367b_getAsicPortUnknownDaFloodingPortmask(unsigned int *pPortmask)
{
 ...
 *      None
 */
int rtl8367b_setAsicPortUnknownMulticastFloodingPortmask(unsigned int portmask)
{
	if(portmask > RTL8367B_PORTMASK)
		return RT_ERR_PORT_MASK;
 ...
 *      None
 */
int rtl8367b_getAsicPortUnknownMulticastFloodingPortmask(unsigned int *pPortmask)
{
 ...
 *      None
 */
int rtl8367b_setAsicPortBcastFloodingPortmask(unsigned int portmask)
{
	if(portmask > RTL8367B_PORTMASK)
		return RT_ERR_PORT_MASK;
 ...
 *      None
 */
int rtl8367b_getAsicPortBcastFloodingPortmask(unsigned int *pPortmask)
{
 ...
 *      None
 */
int rtl8367b_setAsicPortBlockSpa(unsigned int port, unsigned int permit)
{
 ...
 *      None
 */
int rtl8367b_getAsicPortBlockSpa(unsigned int port, unsigned int* pPermit)
{
	if(port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicPortDos(unsigned int type, unsigned int drop)
{
	if(type >= DOS_END)
 ...
 *      None
 */
int rtl8367b_getAsicPortDos(unsigned int type, unsigned int* pDrop)
{
	if(type >= DOS_END)
		return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
int rtl8367b_setAsicPortForceLink(unsigned int port, rtl8367b_port_ability_t *pPortAbility)
{
    unsigned int regData;
    unsigned short *accessPtr;
    ...
    accessPtr =  (unsigned short*)&ability;
 ...
 *      None
 */
int rtl8367b_getAsicPortForceLink(unsigned int port, rtl8367b_port_ability_t *pPortAbility)
{
    int retVal;
    unsigned int regData;
    unsigned short *accessPtr;
 ...
 *      None
 */
int rtl8367b_getAsicPortStatus(unsigned int port, rtl8367b_port_status_t *pPortStatus)
{
    int retVal;
    unsigned int regData;
    unsigned short *accessPtr;
    ...
    accessPtr =  (unsigned short*)&status;
 ...
 *      None
 */
int rtl8367b_setAsicPortForceLinkExt(unsigned int id, rtl8367b_port_ability_t *pPortAbility)
{
    ...
    reg_data = (unsigned int)(*(unsigned short *)pPortAbility);
 ...
 *      None
 */
int rtl8367b_getAsicPortForceLinkExt(unsigned int id, rtl8367b_port_ability_t *pPortAbility)
{
    unsigned int  reg_data;
    unsigned short  ability_data;
    int       retVal;
    ...
    ability_data = (unsigned short)reg_data;
 ...
 *      None
 */
int rtl8367b_setAsicPortExtMode(unsigned int id, unsigned int mode)
{
    int   retVal;
 ...
 *      None
 */
int rtl8367b_getAsicPortExtMode(unsigned int id, unsigned int *pMode)
{
    if(id >= RTL8367B_EXTNO)
        return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
int rtl8367b_setAsicPortEnableAll(unsigned int enable)
{
    if(enable >= 2)
        return RT_ERR_INPUT;
 ...
 *      None
 */
int rtl8367b_getAsicPortEnableAll(unsigned int *pEnable)
{
    int retVal;
    unsigned int regData;
 ...
 *      None
 */
int rtl8367b_setAsicPortSmallIpg(unsigned int port, unsigned int enable)
{
	if(port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicPortSmallIpg(unsigned int port, unsigned int* pEnable)
{
	if(port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_setAsicPortLoopback(unsigned int port, unsigned int enable)
{
    if(port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
 ...
 *      None
 */
int rtl8367b_getAsicPortLoopback(unsigned int port, unsigned int *pEnable)
{
    if(port >= RTL8367B_PORTNO)
		return RT_ERR_PORT_ID;
 ...
 */
int rtl8367b_setAsicPortRTCT(unsigned int portmask)
{
    int       retVal;
 ...
 */
int rtl8367b_getAsicPortRTCTResult(unsigned int port, rtl8367b_port_rtct_result_t *pResult)
{
    int       retVal;
    unsigned int  regData, finish = 1;
