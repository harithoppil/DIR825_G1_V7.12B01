 ...
 *      None
 */
int rtl8367b_setAsicLeakyBucketParameter(unsigned int tick, unsigned int token)
{
    int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicLeakyBucketParameter(unsigned int *tick, unsigned int *token)
{
    int retVal;
 ...
 *      None
 */
int rtl8367b_setAsicAprMeter(unsigned int port, unsigned int qid, unsigned int apridx)
{
    int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicAprMeter(unsigned int port, unsigned int qid, unsigned int *apridx)
{
    int retVal;
 ...
 *      None
 */
int rtl8367b_setAsicAprEnable(unsigned int port, unsigned int aprEnable)
{
    int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicAprEnable(unsigned int port, unsigned int *aprEnable)
{
    int retVal;
 ...
 *      None
 */
int rtl8367b_setAsicWFQWeight(unsigned int port, unsigned int qid, unsigned int qWeight)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicWFQWeight(unsigned int port, unsigned int qid, unsigned int *qWeight)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_setAsicWFQBurstSize(unsigned int burstsize)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicWFQBurstSize(unsigned int *burstsize)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_setAsicQueueType(unsigned int port, unsigned int qid, unsigned int queueType)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicQueueType(unsigned int port, unsigned int qid, unsigned int *queueType)
{
	int retVal;
 ...
 *      None
 */
int rtl8367b_setAsicPortEgressRate(unsigned int port, unsigned int rate)
{
    int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicPortEgressRate(unsigned int port, unsigned int *rate)
{
    int retVal;
    unsigned int regAddr, regData,regData2;
 ...
 *      None
 */
int rtl8367b_setAsicPortEgressRateIfg(unsigned int ifg)
{
    int retVal;
 ...
 *      None
 */
int rtl8367b_getAsicPortEgressRateIfg(unsigned int *ifg)
{
    int retVal;
