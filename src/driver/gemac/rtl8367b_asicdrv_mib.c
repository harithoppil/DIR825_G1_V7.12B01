 ...
 *      None
 */
int rtl8367b_setAsicMIBsCounterReset(unsigned int greset, unsigned int qmreset, unsigned int portmask)
{
	int retVal;
 ...
 */
int rtl8367b_getAsicMIBsCounter(unsigned int port, RTL8367B_MIBCOUNTER mibIdx, unsigned long long* pCounter)
{
	int retVal;
	unsigned int regAddr;
	unsigned int regData;
	unsigned int mibAddr;
	unsigned int mibOff=0;

	/* address offset to MIBs counter */
	const unsigned short mibLength[RTL8367B_MIBS_NUMBER]= {
 ...
 */
int rtl8367b_getAsicMIBsLogCounter(unsigned int index, unsigned int *pCounter)
{
    int retVal;
	unsigned int regAddr;
	unsigned int regData;
 ...
 */
int rtl8367b_getAsicMIBsControl(unsigned int* pMask)
{
	int retVal;
	unsigned int regData;
 ...
 *      None
 */
int rtl8367b_setAsicMIBsResetValue(unsigned int value)
{
 ...
 *      None
 */
int rtl8367b_getAsicMIBsResetValue(unsigned int* value)
{
 ...
 *      None
 */
int rtl8367b_setAsicMIBsUsageMode(unsigned int mode)
{
 ...
 *      None
 */
int rtl8367b_getAsicMIBsUsageMode(unsigned int* pMode)
{
 ...
 *      None
 */
int rtl8367b_setAsicMIBsTimer(unsigned int timer)
{
 ...
 *      None
 */
int rtl8367b_getAsicMIBsTimer(unsigned int* pTimer)
{
 ...
 *      None
 */
int rtl8367b_setAsicMIBsLoggingMode(unsigned int index, unsigned int mode)
{
 ...
 *      None
 */
int rtl8367b_getAsicMIBsLoggingMode(unsigned int index, unsigned int* pMode)
{
	if(index > RTL8367B_MIB_MAX_LOG_MODE_IDX)
		return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
int rtl8367b_setAsicMIBsLoggingType(unsigned int index, unsigned int type)
{
	if(index > RTL8367B_MIB_MAX_LOG_MODE_IDX)
		return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
int rtl8367b_getAsicMIBsLoggingType(unsigned int index, unsigned int* pType)
{
	if(index > RTL8367B_MIB_MAX_LOG_MODE_IDX)
		return RT_ERR_OUT_OF_RANGE;
 ...
 *      None
 */
int rtl8367b_setAsicMIBsResetLoggingCounter(unsigned int index)
{
    int retVal;
