 ...
 */
int rtl8367b_setAsicCputagEnable(unsigned int enabled)
{
    if(enabled > 1)
 ...
 *      None
 */
int rtl8367b_getAsicCputagEnable(unsigned int *pEnabled)
{
 ...
 */
int rtl8367b_setAsicCputagTrapPort(unsigned int port)
{
 ...
 *     None
 */
int rtl8367b_getAsicCputagTrapPort(unsigned int *pPort)
{
 ...
 *     None
 */
int rtl8367b_setAsicCputagPortmask(unsigned int portmask)
{
 ...
 *     None
 */
int rtl8367b_getAsicCputagPortmask(unsigned int *pPortmask)
{
 ...
 *     None
 */
int rtl8367b_setAsicCputagInsertMode(unsigned int mode)
{
 ...
 *     None
 */
int rtl8367b_getAsicCputagInsertMode(unsigned int *pMode)
{
 ...
 *     None
 */
int rtl8367b_setAsicCputagPriorityRemapping(unsigned int srcPri, unsigned int newPri)
{
 ...
 *     None
 */
int rtl8367b_getAsicCputagPriorityRemapping(unsigned int srcPri, unsigned int *pNewPri)
{
 ...
 *     None
 */
int rtl8367b_setAsicCputagPosition(unsigned int postion)
{
 ...
 *     None
 */
int rtl8367b_getAsicCputagPosition(unsigned int* pPostion)
{
 ...
 *    	forwarded to CPU port, and all ports cannot parse CPU tag.
 */
int rtl8367b_setAsicCputagMode(unsigned int mode)
{
    if(mode > 1)
        return RT_ERR_INPUT;
 ...
 *      None
 */
int rtl8367b_getAsicCputagMode(unsigned int *pMode)
{
 ...
 *    	forwarded to CPU port, and all ports cannot parse CPU tag.
 */
int rtl8367b_setAsicCputagRxMinLength(unsigned int mode)
{
    if(mode > 1)
        return RT_ERR_INPUT;
 ...
 *      None
 */
int rtl8367b_getAsicCputagRxMinLength(unsigned int *pMode)
{
