...
void FoeDumpEntry(uint32_t Index)
{
    ...
    NAT_PRINT("DMAC=%02X:%02X:%02X:%02X:%02X:%02X \
	    ...
	    entry->dmac_hi[0], entry->dmac_hi[1], entry->dmac_lo[0],
	    entry->dmac_lo[1], entry->dmac_lo[2],entry->dmac_lo[3], 
	    entry->smac_hi[0],entry->smac_hi[1], entry->smac_lo[0],
	    entry->smac_lo[1],entry->smac_lo[2],entry->smac_lo[3]);
#else
    NAT_PRINT("DMAC=%02X:%02X:%02X:%02X:%02X:%02X \
	       SMAC=%02X:%02X:%02X:%02X:%02X:%02X\n",
