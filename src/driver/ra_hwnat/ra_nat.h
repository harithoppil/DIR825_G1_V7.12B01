...
#define FOE_ALG(skb)		    ((PdmaRxDescInfo4 *)(&(skb)->foe[0]))->ALG 
#define FOE_AI(skb)		    ((PdmaRxDescInfo4 *)(&(skb)->foe[0]))->AI
#define FOE_SP(skb)		    ((PdmaRxDescInfo4 *)(&(skb)->foe[0]))->SP //src_port or user priority
