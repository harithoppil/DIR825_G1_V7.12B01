...
#define DFL_PPE_DSCP		(1) /* IPv4 DSCP is assigned by PPE */ 
...
*/
#define DFL_FOE_KA_ORG		1//0   /* KeepAlive packet with (0:NewHeader,1:OrgHeader) */
#define DFL_FOE_KA_EN		1   /* Keep alive enable */
#define DFL_FOE_ACL_AGE		0   /* ACL link to FoE age enable */
