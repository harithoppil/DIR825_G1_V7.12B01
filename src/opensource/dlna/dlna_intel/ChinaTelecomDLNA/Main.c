...
int main(void) 
{
	...
	MediaServer_GetConfiguration()->Manufacturer = SITECOMVERSION;
	MediaServer_GetConfiguration()->ManufacturerURL = SITECOMVERSION;
	MediaServer_GetConfiguration()->ModelName = SITECOMVERSION;
	MediaServer_GetConfiguration()->ModelDescription = SITECOMVERSION;
	MediaServer_GetConfiguration()->ModelNumber = SITECOMVERSION;
	MediaServer_GetConfiguration()->ModelURL = SITECOMVERSION;
