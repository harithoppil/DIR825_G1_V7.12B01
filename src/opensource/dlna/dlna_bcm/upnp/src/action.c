...
static BUPnPActionErrorType g_upnpErrors[] =
{
    ...
    { UPNP_E_SERVICE_NOT_FOUND,                    "Service Not Found" },
    { UPNP_E_NO_SUCH_CONTAINER,                    "No Such Container" },
    { UPNP_E_BAD_METADATA,                             "Bad Metadata" },
    { UPNP_E_NO_SUCH_SOURCE_RESOURCE,             "No Such Source Resource" },
    { UPNP_E_NO_SUCH_DESTINATION_RESOURCE,          "No Such Destination Resource" },
    { UPNP_E_CANNOT_PROCESS_THE_REQUEST,          "Can Not Process The Request" },
    { UPNP_E_SUCCESS,                            NULL }
};
