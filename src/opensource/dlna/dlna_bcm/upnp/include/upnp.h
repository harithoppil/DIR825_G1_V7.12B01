...
#define UPNP_E_NO_SUCH_SOURCE_RESOURCE               714
#define UPNP_E_NO_SUCH_DESTINATION_RESOURCE      718
#define UPNP_E_CANNOT_PROCESS_THE_REQUEST          720
/* Add by tuhanyu, end */
...
/*
typedef struct BUPnPRemoteCamera
{
    BUPnPRemoteDeviceHandle Rdevice;
	BUPnPRemoteDeviceHandle Next;
} BUPnPCameraDevice, * BUPnPRemoteCameraHandle;

extern  struct BUPnPRemoteCamera * BUPnPRemoteCamera;
*/
#endif
/* Add by tuhanyu, end */
...
/* Add by tuhanyu, for upnp device management of separate AP, 2011/04/11, start*/
#ifdef DMP_X_CT_COM_UPNP_DM_CP_1
    char *manufacturerOUI;          /** manufacturerOUI */
    char *productClass;          /** productClass */
    char *serialNumberDev;          /** serialNumber */
...
/* Add by tuhanyu, for upnp device management of separate AP, 2011/04/15, start */
#ifdef DMP_X_CT_COM_UPNP_DM_CP_1
void BUPnPControlPoint_GetTWCalllbackOpenSettings(BUPnPControlPointOpenSettings* pOpenSettings) ;
typedef struct UPnp_action_Info
{
   char servicename[64];
   char actionname[64];
   char argname[64];          /*argument name*/
   char argASVname[64];    /*node parameter name*/
   int action;
}UPnp_action_Info, *pUPnp_action_Info;
#endif
/* Add by tuhanyu, end */
