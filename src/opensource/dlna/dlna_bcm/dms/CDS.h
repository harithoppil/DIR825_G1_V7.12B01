...
typedef struct _cds_create_object_in_params_{
    unsigned int ContainerID;        /*String Value uniquely identifies the object */
    struct buffer_t *Elements;      /*DIDL input of the function in this buffer*/
}cds_create_object_in_params,*pcds_create_object_in_params;

typedef struct _cds_create_object_out_params_{
    unsigned int ObjectID;                     /*String Value uniquely identifies the object */
    struct buffer_t    *ResultOutBuff;    /*DIDL output of the function in this buffer*/
}cds_create_object_out_params,*pcds_create_object_out_params;


typedef struct _cds_destroy_object_in_params_{
    unsigned int ObjectID;        /*String Value uniquely identifies the object */
}cds_destroy_object_in_params,*pcds_destroy_object_in_params;


typedef struct _cds_import_resource_in_params_{
    char *SourceURI;
    char *DestinationURI;
}cds_import_resource_in_params,*pcds_import_resource_in_params;

typedef struct _cds_import_resource_out_params_{
    char *TransferID;
}cds_import_resource_out_params,*pcds_import_resource_out_params;
/* Add by tuhanyu, end */
...
BC_STATUS cds_update();
void cds_scan_thread();
/* 
 * cds_init:
