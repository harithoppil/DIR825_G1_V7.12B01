...
#define UPDATE_PERIOD    60     /* default update period, 1 minutes*/
...
typedef struct _DMS_CONTEXT_{
    ...
    unsigned int        updatePeriod;                   /* The period of scanning media file */
    char                   mediaPath[256];                /* IP Address is common*/
