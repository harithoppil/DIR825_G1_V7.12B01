...
int general_query_interval = MLD_DEF_QI;
int general_query_response_interval = MLD_DEF_QRI;
int lm_query_interval = 1;
int go_on = 1;
...
mld_interface_create(struct in6_addr * pIfaddr, char *ifname, mifi_t index)
{
  ...
  ifp->mldi_version = version; 
  ifp->mldi_qi = general_query_interval;
  ifp->mldi_qri = general_query_response_interval;
...
#endif
{
  ...
  strcpy(upstream_interface,argv[1]);
  version = atoi(argv[2]);
  enable_fast_leaving	= atoi(argv[3]);
  general_query_interval = atoi(argv[4]);
  general_query_response_interval = atoi(argv[5]);
  lm_query_interval = atoi(argv[6]);

  /*printf("-------------upstream_interface = %s,version =%d,enable_fast_leaving = %d,general_query_interval = %d,general_query_response_interval = %d,lm_query_interval = %d\n",\
  upstream_interface,version,enable_fast_leaving,general_query_interval,general_query_response_interval,lm_query_interval);*/
